...
export interface ActionOptions
  extends
    Partial<Omit<ActionState, "actionId">>,
...
export type CustomInputFieldsValues = Record<
  string,
  TextWithCheckboxValue | boolean | string | any
>;
...
export type InitialSettingsMap = Record<string, string>;
...
export type StudyOverrides = Record<string, StudyOverrideValueType>;
...
export type WatchListSymbolListMap = Record<string, WatchListSymbolList>;
