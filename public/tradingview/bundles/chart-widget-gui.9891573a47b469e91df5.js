    ...
    56786: (e, t, s) => {
      ...
      class M {
        ...
        _showActions() {
          ...
          (this._el.classList.toggle(y.withTail, e),
            this._updateTitleMaxWidth());
        }
        _hideActions() {
          null !== this._el &&
        ...
        _updateActionVisibilities(e) {
          null !== this._actionsParentEl &&
            this._actionsParentEl
              ...
              [
                e
              ].classList.toggle(m.blockHidden, !this._actionsSpawnArray[e].visible.value());
        }
      ...
      class Ss extends zt {
        ...
        async _getHtmls() {
          ...
          let i = null,
            l = null;
          try {
            ((i = await this._model.description()),
              (l = this._model.exchange()));
          } catch (e) {
            Qt.logError(
              ...
              if (e > a + 1) {
                ...
                for (let s = 0; s < e; s++) {
                  ...
                  (this._dataSourceViewModels[s].setGlobalVisibility(e),
                    e ||
                      (t += `${0 === t.length ? "" : ", "}${this._dataSourceViewModels[s].getFullTitle()}`));
                }
                return (
