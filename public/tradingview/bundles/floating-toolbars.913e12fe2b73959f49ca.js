    ...
    55753: (t, e, o) => {
      ...
      class _ extends r.FloatingToolbar {
        ...
        _createLinetoolWidget(t) {
          const e = `<span class="tv-favorited-drawings-toolbar__widget apply-common-tooltip ${t === c.tool.value() ? "i-active" : ""}" title="${h.lineToolsInfo[t].localizedName}" data-name="FavoriteToolbar${t}">${h.lineToolsInfo[t].icon}</span>`,
                    ...
                    const t = [
                      ...
                      e = (function () {
                        ...
                        if (
                          ...
                          return t;
                        return (
                          t.push(...(0, q.createSyncDrawingActions)(r, d)),
                          t
                        );
                      })();
