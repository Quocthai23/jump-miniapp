  ...
  [4079],
  {
    58907: (t, e, i) => {
      var a = i(72927).Point,
        ...
        l = i(54041).DateFormatter,
        n = i(18675).TimeFormatter,
        d = i(16932).calcTextHorizontalShift,
        o = i(76553).isRtl,
        h = i(54837).CHART_FONT_FAMILY,
          ...
          if (null !== this._data) {
            ...
            if (
              ...
              var v = m + 8 + (i - r) / 2,
                f = d(t, r);
              if (
                (t.fillText(this._data.dateString, v + f, u + e + 8),
          ...
          if (
            ...
            if (null != s) {
              ...
              if (((this._point = new a(d, r)), this._gotoDateResult.eod))
                ...
                ((this._dateString = new l().format(o)),
                  this._series.isDWM() ||
