(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1583],
  {
    ...
    60809: (e, t, i) => {
      "use strict";
      (i.r(t),
        i.d(t, { cacheIsValid: () => d, BezierQuadroPaneView: () => h }));
      var n = i(16282),
        r = i(50968),
        s = i(67857),
        a = i(87088),
        ...
        _drawImpl(e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            for (var w = 0; w < this._data.lines.length; w++)
              (e.fillText(this._data.lines[w], _, p),
        ...
        _updateImpl() {
          if (
            ...
            if (
              ...
              ((o.data = 1),
                n.append(this.createLineAnchor({ points: [o] }, 1)));
            }
            this._renderer = n;
          }
        }
      ...
      t.FibRetracementPaneView = class extends u {
        ...
        getCacheRects(e, t) {
          ...
          var a = this._points[0],
            ...
            l = Math.min(a.x, o.x),
            d = Math.max(a.x, o.x);
          ((a = new r(l, this._levels[t].y)),
            (o = new r(d, this._levels[t].y)));
          var h,
    ...
    63245: (e, t, i) => {
      ...
      class x extends c.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          ((f = (0, r.transformPoint)(w, f)),
            (x = (0, r.transformPoint)(w, x)));
          const m = _.add(f);
          m.data = 0;
      ...
      class R extends s {
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            ((C = new n(b, this._entryLevel)),
              (M = new n(L, this._closeLevel)));
            (((k = {}).points = [C, M]),
              (k.color = "white"),
              (k.linewidth = 0),
              (k.backcolor = y.stopBackground.value()),
          ...
          ((C = new n(T, this._profitLevel)),
            (M = new n(S, this._profitLevel)));
    ...
    45188: (e, t, i) => {
      ...
      class g {
        constructor(e) {
          ...
          const t = c,
            i = h + t;
          ((this._maxRowHeight = 3 * i - t + 2 * u + 2),
            this._recreateCanvas());
        }
        destroy() {
