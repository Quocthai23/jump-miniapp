...
declare class SymbolConversion {
  ...
  convertSymbolsInObject(
    obj: any,
    symbolsFields?: Array<string>,
    symbolMode?: string
  ): Promise<any>;
...
declare function signUserSignedAction(
  wallet: Wallet,
  action: any,
  payloadTypes: Array<{
    name: string;
...
declare function signUsdTransferAction(
  wallet: Wallet,
  action: any,
  isMainnet: boolean
): Promise<Signature>;
declare function signWithdrawFromBridgeAction(
  wallet: Wallet,
  action: any,
  isMainnet: boolean
): Promise<Signature>;
...
declare function orderWireToAction(
  orders: OrderWire[],
  grouping?: Grouping,
  builder?: Builder
): any;
...
declare class WebSocketSubscriptions {
  ...
  subscribeToUserActiveAssetData(
    user: string,
    coin: string,
    callback: (
      data: WsUserActiveAssetData & {
        user: string;
      }
    ) => void
  ): Promise<void>;
...
declare class WebSocketPayloadManager {
   ...
   */
  cancelOrder(cancelParams: { coin: string; o: number | string }): Promise<any>;
  /**
   ...
   */
  modifyOrder(modifyParams: { oid: number | string; order: any }): Promise<any>;
  /**
...
export {
  ...
  type CDepositResponse,
  CHAIN_IDS,
  type CWithdrawResponse,
  ...
  type Delegation,
  type DelegatorHistoryEntry,
  type DelegatorReward,
  type DelegatorSummary,
  ENDPOINTS,
  ExchangeType,
  type ExtendedOpenOrder,
  type ExtraAgent,
  type FrontendOpenOrders,
  type FundingHistory,
  ...
  type Portfolio,
  type PortfolioPeriodData,
  type PortfolioPeriods,
  type PreTransferCheck,
  type PredictedFunding,
  type PredictedFundings,
  type Referral,
  type ReserveRequestWeightRequest,
  ...
  type SpotToken,
  type SpotUserResponse,
  type SubAccount,
  type SubAccountSpotTransferResponse,
  type SubAccountTransferResponse,
  type Tif,
  type TokenDelegateResponse,
  type TokenDetails,
  type TriggerOrder,
  type TriggerType,
  type TwapCancelRequest,
  ...
  type UserFills,
  type UserFunding,
  type UserFundingDelta,
  type UserFundingEntry,
  type UserNonFundingLedgerDelta,
  type UserNonFundingLedgerEntry,
  type UserNonFundingLedgerUpdates,
  type UserOpenOrder,
  type UserOpenOrders,
  type UserOrderHistory,
  type UserOrderHistoryEntry,
  type UserRateLimit,
  type UserRole,
  type ValidatorStats,
  type ValidatorSummary,
  type VaultDetails,
  type VaultDistributeRequest,
  type VaultEquity,
  type VaultFollower,
  type VaultModifyRequest,
  ...
  type WsUserFunding,
  type WsUserFundings,
  type WsUserNonFundingLedgerUpdate,
  type WsUserNonFundingLedgerUpdates,
  cancelOrderToAction,
